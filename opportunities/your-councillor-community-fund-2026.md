---
id: opp-2026-016
name: Surrey County Council — Your Councillor Community Fund (Runnymede)
type: opportunity
funder: Surrey County Council
...
funding_cycle_notes: Annual cycle opens around May each year; closes end of January. Each councillor allocates up to £5,000 to projects in their area. Englefield Green falls in Runnymede division, represented by Cllr Marisa Heath.

geography: Runnymede Borough (Englefield Green division)
charity_registration_required: unclear
legal_form_required: Community organisation — likely flexible; no charity number stated as requirement
eligibility_summary: Community groups and voluntary organisations delivering activities that benefit local people in the councillor's area. Flexible — can fund small purchases, events, activities. Application via the local county councillor who provides a link to the online form. Contact: Cllr Marisa Heath (Englefield Green), marisa.heath@surreycc.gov.uk.
...
gate_open_status: upcoming
gate_deadline_realism: pass
gate_evidence: pass

score_mission_fit: 4
score_programme_fit: 3
score_evidence_readiness: 4
score_likelihood_of_success: 3
score_grant_size_fit: 3
score_relationship_value: 4
score_repeat_funding_potential: 3
score_urgency: 4
score_application_burden: 1
score_restriction_cost: 2
score_confidence: 3
score_rationale: Very low application burden — just an email to the local councillor plus a short form they send. Geography is exactly right (Englefield Green = Runnymede). No charity registration required. Up to £5,000 is useful for instrument purchase or a workshop series. Repeat potential if relationship with councillor is warm. Urgency is high because the cycle is expected to open May 2026.
...
- Each Surrey County Councillor allocated £5,000/year to local community organisations. Source: surreycc.gov.uk/community/voluntary-community-and-faith-sector/funding/community-projects-fund/community-fund, checked 2026-04-27.
- Englefield Green is in Runnymede. Cllr Marisa Heath is the Surrey County Councillor for the Runnymede Englefield Green division. Source: englefieldgreen.org/your-councillors, checked 2026-04-27.
- Charity registration not listed as a requirement. Fund described as flexible. Source: SCC website above, checked 2026-04-27.
