---
id: opp-2026-009
name: BBC Children in Need — Project Grants
type: opportunity
...
gate_evidence: unclear

score_mission_fit: 3
score_programme_fit: 3
score_evidence_readiness: 2
score_likelihood_of_success: 2
score_grant_size_fit: 4
score_relationship_value: 3
score_repeat_funding_potential: 3
score_urgency: 2
score_application_burden: 4
score_restriction_cost: 3
score_confidence: 2
score_rationale: Potentially strong fit if WFBA can demonstrate that the majority of outreach beneficiaries experience disadvantage — but this is currently unconfirmed. Do not apply without evidence of disadvantage in target beneficiary group. Application burden is high (mandatory advice session, strong safeguarding pack required).
...
BBC CiN is a major fund but has a high bar: majority of beneficiaries must be experiencing disadvantage (poverty, disability, abuse, neglect, etc.). This is not just a music education fund — it funds organisations where disadvantage is the primary framing.

WFBA's outreach framing (access regardless of background) is a partial fit, but until the target school's Pupil Premium data is confirmed and the beneficiary disadvantage case is built, this application would be weak. Do not attempt without strong disadvantage evidence.

Also note: mandatory pre-application advice session required for all new applicants.
